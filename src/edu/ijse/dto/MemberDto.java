...
public class MemberDto {
    ...
    public MemberDto(String memberId, String name, String address, String contact_number, double membership_start_date, String membership_expiry_date) {
    ...
    public String toString() {
        return "MemberDto{" + "memberId=" + memberId + ", name=" + name + ", address=" + address + ", contact_number=" + contact_number + ", membership_start_date=" + membership_start_date + ", membership_expiry_date=" + membership_expiry_date + '}';
    }
